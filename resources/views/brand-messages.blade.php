  ...
  .another-message .message-content-row .col-md-12{
    ...
    <div class="container-fluid">
      <div class="page-title">
        <div class="row">
          <div class="col-6">
            <h3><a href="{{ url('brand/chat') }}">Back To List</a></h3>
          </div>
    ...
    <input id="channelname" type="hidden" placeholder="username" value="{{ $chat }}" />
    <input id="username-input" type="hidden" placeholder="username" value="{{ $username }}" />
    <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
    <img id="connect-image" src="{{ asset('img/connect-image.png') }}" style="width: 1px;" />
<script>
