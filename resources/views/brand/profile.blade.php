  ...
  <div class="container-fluid">
    <div class="row size-column">
      <div class="col-xl-12 box-col-12 xl-100">
        <form class="theme-form" method="POST" action="{{ url('brand/profile-update')}}">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" value="{{ $data->name }}" type="text" required="" name="name">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="brand_type" id="brand_type">
                      ...
                      @foreach($foi as $value)
                        <option value="{{ $value->name }}" <?php if($data->brand_type == $value->name){ echo "selected";} ?>>{{ $value->name }}</option>
                      @endforeach
                  </select>
                </div>
              </div>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="language" id="language" required>
                    ...
                    <?php 
                      foreach($lang as $c){
                        ?>
                          <option value="<?php echo $c['name']; ?>" <?php if($data->language == $c['name']){ echo "selected";} ?>><?php echo $c['name']; ?></option>    
                        <?php    
                      }
                    ?>
                ...
                <div class="form-group">
                  ...
                  <?php 
                    foreach($countries as $c){
                      ?>
                        <option value="<?php echo $c['name']; ?>" <?php if($data->city == $c['name']){ echo "selected";} ?>><?php echo $c['name']; ?></option>    
                      <?php    
                    }
                  ?>
                  </select>
