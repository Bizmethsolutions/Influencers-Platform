        ...
        <ul class="nav-menus">
          ...
          <li class="profile-nav onhover-dropdown p-0 me-0">
            ...
            <ul class="profile-dropdown onhover-show-div">
              <li><a href="{{ url('/influencer/profile') }}"><i data-feather="user"></i><span>Profile </span></a></li>
              ...
              <li><a href="{{ url('influencer/logout') }}"><i data-feather="log-in"> </i><span>Logout</span></a></li>
            </ul>
          </li>
        </ul>
      </div>
