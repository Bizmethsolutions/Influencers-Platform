  ...
  <div class="container-fluid">
    <div class="row size-column">
      <div class="col-xl-12 box-col-12 xl-100">
        <form class="theme-form" method="POST" action="{{ url('agency/updateBrands')}}">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" value="{{ $brands->name }}" type="text" required="" name="name">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label class="col-form-label">Email Address</label>
                  <input class="form-control" value="{{ $brands->email }}" type="email" required="" name="email" placeholder="Test@gmail.com">
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <select class="form-control" name="brand_type" required="" id="foi">
                    <option></option>
                    @foreach($foi as $value)
                      <option value="{{ $value->name }}" <?php if($brands->brand_type == $value->name ){ echo "selected";} ?>>{{ $value->name }}</option>
                    @endforeach
                  </select>
                </div>
              </div>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" required="" name="language" id="language">
                    ...
                    <?php 
                      foreach($lang as $c){
                        ?>
                          <option value="<?php echo $c['name']; ?>" <?php if($brands->language == $c['name'] ){ echo "selected";} ?>><?php echo $c['name']; ?></option>    
                        <?php    
                      }
                    ?>
                  </select>
            ...
            <div class="row">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="city" required="" id="city">
                    ...
                    foreach($countries as $c){
                        ?>
                          <option value="<?php echo $c['name']; ?>" <?php if($brands->city == $c['name'] ){ echo "selected";} ?>><?php echo $c['name']; ?></option>    
                        <?php    
                    }
                    ?>
                  </select>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" value="{{ $brands->agency }}" type="text" required="" name="agency">
                </div>
              </div>
            </div>
