            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" value="{{ $data->brand_type }}" type="text" name="brand_type" required="">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label class="col-form-label">Brand Language</label> 
                  <input class="form-control" value="{{ $data->language }}" type="text" required="" name="language">
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" value="{{ $data->city }}" type="text" name="city" required="">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
