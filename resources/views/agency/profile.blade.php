  ...
  <div class="container-fluid">
    <div class="row size-column">
      <div class="col-xl-12 box-col-12 xl-100">
        <form class="theme-form" method="POST" action="{{ url('agency/profile-update')}}">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="agency" id="agency">
                      ...
                      @foreach($foi as $value)
                        <option value="{{ $value->name }}" <?php if($data->agency == $value->name){ echo "selected";} ?>>{{ $value->name }}</option>
                      @endforeach
                  </select>
                </div>
              </div>
