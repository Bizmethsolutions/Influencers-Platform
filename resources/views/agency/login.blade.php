      ...
      <div class="login-card">
        <div>
          <div class="login-main"> 
            <form class="theme-form" method="POST" action="{{ url('agency-login')}}">
              ...
              <p class="mt-4 mb-0 text-center">Don't have account?<a class="ms-2" href="{{ url('agency/register') }}">Create Account</a></p>
            </form>
          </div>
        </div>
      </div>
