  ...
  <div class="container-fluid">
    <div class="row size-column">
      <div class="col-xl-12 box-col-12 xl-100">
        <form class="theme-form" method="POST" action="{{ url('agency/save_campaign')}}" enctype="multipart/form-data">
            <div class="row">
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" name="email" value="" type="email" required="" placeholder="Test@gmail.com">
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" value="" type="text" required="" name="due_date" id="due_date">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <label class="col-form-label">Description</label>
                  <input class="form-control" value="" type="text" required="" name="description">
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control" value="" type="number" required="" name="price">
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control" value="" type="text" required="" name="phone_number"  placeholder="9999999999">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" onchange="typeid(this.value)" name="type" required>
            ...
            <div class="row" id="typeid" style="display:none;">
                <div class="col-md-6">
                    <div class="form-group">
